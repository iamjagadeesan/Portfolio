...
function About({ toggle }) {
  ...
  return (
    ...
    <div className={`text-nowrap relative text-2xl lg:text-4xl font-thin font-audiowide bg-clip-text text-transparent bg-gradient-to-r from-violet-300 via-violet-500 to-violet-700 px-2 rounded-lg`}>Persona</div>
    ...
    <div className="z-30 w-full h-full lg:h-screen flex flex-col lg:flex-row justify-between items-center gap-4 p-4 lg:p-12 lg:px-24 lg:pt-8">
      ...
      <div className={` ${toggle?'drop-shadow-[0_0_10px_rgba(139,92,246,0.3)] lg:drop-shadow-[0_0_10px_rgba(139,92,246,0.3)]':'drop-shadow-[0_0_10px_rgba(139,92,246,0.3)] lg:drop-shadow-[0_0_10px_rgba(139,92,246,0.8)]'} h-auto lg:h-full w-full lg:w-1/3 flex flex-col justify-center items-center`}>
        <div className="relative w-full h-[80vh] lg:h-full rounded-2xl shadow-lg border-2 border-violet-700 overflow-hidden">
          ...
          <div className="absolute inset-0 z-10 flex overflow-hidden">
              <div key={index} className="h-full w-full transition-all duration-700 bg-cover bg-start" style={{ backgroundImage: images[index] }}></div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-2/3 flex flex-col gap-4 p-4">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="border-l-2 border-violet-700 pl-6 w-full">
            <div className="mb-6 relative">
              ...
              <div className={` ${toggle? 'bg-gray-950' : 'bg-gray-100'} p-4 rounded-lg shadow-md`}>
                ...
                <p className={`text-sm ${toggle?'text-gray-400':'text-gray-600'}`}>Graduated: 2024 | CGPA: 8.56</p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className={` ${toggle? 'bg-gray-950' : 'bg-gray-100'} p-4 rounded-lg shadow-md`}>
                ...
                <p className={`text-sm ${toggle?'text-gray-400':'text-gray-600'}`}>Graduated: 2022 | Percentage: 80.72%</p>
              </div>
            </div>
          </div>

          {/* Experience */}
          <div className={`w-full ${toggle?'bg-gray-950 text-gray-200':'bg-gray-100 text-gray-800'} rounded-lg shadow-md p-4 flex flex-col justify-evenly items-start`}>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          {/* Soft Skills */}
          <div className={`w-full py-4 ${toggle?'bg-gray-950 text-gray-200':'bg-gray-100 text-gray-800'} p-4 rounded-lg shadow-md`}>
          ...
          {/* Other Interests */}
          <div className={`w-full ${toggle?'bg-gray-950 text-gray-200':'bg-gray-100 text-gray-800'} p-4 rounded-lg shadow-md`}>
            <h1 className="text-xl text-violet-700 font-semibold">Other Interests</h1>
