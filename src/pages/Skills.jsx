...
function Skills({toggle, width}) {
  ...
  return (
    ...
    {...(width < 500
        ...
        : {})}
    >
    <div className={`text-nowrap relative text-2xl lg:text-4xl font-thin font-audiowide bg-clip-text text-transparent bg-gradient-to-r from-violet-300 via-violet-500 to-violet-700 px-2 rounded-lg`}>Tech Stack</div>
