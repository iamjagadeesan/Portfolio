      ...
      <div className="absolute inset-1 overflow-hidden p-5 flex flex-col lg:flex-col items-center justify-center gap-4">
        ...
        <div className="text-xs lg:text-base mt-4 w-[80vw] md:w-1/2 lg:w-1/3 lg:px-4 flex flex-row justify-between items-center">
          ...
          <Link
            to="/contact"
            href="#contact"
            className={`text-sm lg:text-lg inline-block bg-gradient-to-br from-violet-400 via-violet-700 to-violet-950 lg:py-2 lg:px-4 py-2 px-2 rounded-lg font-semibold transition-transform hover:scale-105 shadow-md ${
              toggle ? "text-white/80 border-violet-700 border-[1px] lg:border-[1px]" : "text-gray-100 border-violet-400 border-[1px] lg:border-[2px]"
            }`}
          >
            Let's Connect Yours
          </Link>
